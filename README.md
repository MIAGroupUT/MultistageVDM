...
The rigid registration consists of a global and a local step. Both registration steps are implemented with the `PatientRegistration` class, this class is located within `utils_image_registration.py`. For class initialization, the following file structure is expected:
